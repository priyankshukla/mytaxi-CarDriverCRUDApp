...
INSERT INTO MANUFACTURER(ID, DATE_CREATED, NAME) VALUES(2,  now(), 'Mercedes-Benz');
-- Create 3 CARS
INSERT INTO CAR(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, DELETED) VALUES(1, true, now(),  'ELECTRIC', 'ABCD', 4.5, 4, 1, false);
INSERT INTO CAR(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, DELETED) VALUES(2, true, now(),  'ELECTRIC', 'ABCD', 4.5, 2, 2, false);
INSERT INTO CAR(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, DELETED) VALUES(3, false, now(),  'GAS', 'ABCD', 4, 4, 1,true);
